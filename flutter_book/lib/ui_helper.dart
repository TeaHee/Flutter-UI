...
List<BestSellersCard> bestSellersBook = [
  BestSellersCard(
      "assets/images/books/book_zoo.png", "Christopher Wilson", "Zoo", "4"),
  BestSellersCard("assets/images/books/book_paper.png", "Rebecca Mackenzie",
      "In A Land Of Paper Gods", "5"),
  BestSellersCard("assets/images/books/book_tattletale.png",
      "Sarah J. Noughton", "Tattletale", "4"),
];

List<RecentlyViewedCard> recentlyViewedBook = [
  RecentlyViewedCard(
      "assets/images/books/book_tree.png", "Jake Arnott", "The Fatal Tree"),
  RecentlyViewedCard(
      "assets/images/books/book_four.png", "LOTZ, SARAH", "Day Four"),
  RecentlyViewedCard(
      "assets/images/books/book_d2d.png", "Edward Humes", "Door to Door"),
];
